...
import dio.me.board.dto.BoardColumnInfoDTO;
import dio.me.board.dto.CardDetails;
import dio.me.board.exception.CardBlockedException;
import dio.me.board.exception.CardFinishedException;
import dio.me.board.exception.EntityNotFoundException;
import dio.me.board.persistence.dao.BlockDAO;
import dio.me.board.persistence.dao.CardDAO;
import dio.me.board.persistence.Entity.CardEntity;
...
import static dio.me.board.persistence.Entity.BoardColumnKindEnum.FINAL;
...
public class CardService {
    ...
    private CardDetails getCardDetailsDTO(Long cardId) throws SQLException, CardBlockedException {
        var cardDAO = new CardDAO(connection);
